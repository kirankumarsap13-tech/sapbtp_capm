...
using  { kiran.db.master, kiran.db.transaction } from './data-model';
...
context CDSViews {
   ...
   select from transaction.purchaseorder{
    ...
    PARTNER_GUID.COMAPNY_NAME as ![CompanyName],
  ...
  define view ProductOrders as 
    ...
    {   
      ...
      SUPPLIER_GUID.COMAPNY_NAME as![SupplierName],
      SUPPLIER_GUID.ADDRESS_GUID.COUNTRY as ![Country],
      //exposes association like ABAP which will lazy load orders of a give product
